...
function initialize(a) {
    ...
    if (/Mobile|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        ...
        $("#inst_main_body").html("The goal of Hextelor is to stop blocks from leaving the inside of the outer gray hexagon<br><br> Tap the left and right sides of the screen to rotate the Hexagon<br><br>Clear blocks and get points by making 3 or more blocks of the same color touch<br><br>Time left before your combo streak disappears is indicated shown by <span style='color:#f1c40f;'>the</span> <span style='color:#e74c3c'>colored</span> <span style='color:#3498db'>lines</span> <span style='color:#2ecc71'>in</span> the outer hexagon<br><br> Toggle speeding up the game by tapping the inner hexagon");
    }
...
function handleTapBefore(e) {
    ...
    if (x < 50 && y < 50 && $('.helpText').is(':visible')) {
        showHelp();
        return;
    } else if($('#helpScreen').is(':visible')) {
        $('#helpScreen').fadeOut(150, "linear");
        return;
    }
}
